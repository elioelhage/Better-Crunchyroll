...
const DEFAULTS = { shortcuts:{skip:'KeyS',next:'KeyN'}, autoSkipIntro:true, autoSkipRecap:true, autoSkipCredits:true, autoNextAfterCredits:false, animateEpisodeList:true, blurUpcoming:false, hideUpcomingTitles:false };
