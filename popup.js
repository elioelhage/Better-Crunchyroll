...
const KEYS = { shortcuts:'betterCrunchyrollShortcuts', autoSkipIntro:'betterCrunchyrollAutoSkipIntro', autoSkipRecap:'betterCrunchyrollAutoSkipRecap', autoSkipCredits:'betterCrunchyrollAutoSkipCredits', blurUpcoming:'betterCrunchyrollBlurUpcoming', hideUpcomingTitles:'betterCrunchyrollHideUpcomingTitles', autoNextAfterCredits:'betterCrunchyrollAutoNextAfterCredits', animateEpisodeList:'betterCrunchyrollAnimateEpisodeList' };
const DEFAULTS = { shortcuts:{skip:'KeyS',next:'KeyN'}, autoSkipIntro:false, autoSkipRecap:false, autoSkipCredits:false, autoNextAfterCredits:false, animateEpisodeList:true, blurUpcoming:false, hideUpcomingTitles:false };
...
const settingButtons={autoSkipIntro:document.getElementById('autoSkipIntro'),autoSkipRecap:document.getElementById('autoSkipRecap'),autoSkipCredits:document.getElementById('autoSkipCredits'),autoNextAfterCredits:document.getElementById('autoNextAfterCredits'),animateEpisodeList:document.getElementById('animateEpisodeList'),blurUpcoming:document.getElementById('blurUpcoming'),hideUpcomingTitles:document.getElementById('hideUpcomingTitles')};
...
function normalizeSettings(stored){const {previous:_ignoredPrevious,...storedShortcuts}=stored[KEYS.shortcuts]||{};return {shortcuts:{...DEFAULTS.shortcuts,...storedShortcuts},autoSkipIntro:Boolean(stored[KEYS.autoSkipIntro]),autoSkipRecap:Boolean(stored[KEYS.autoSkipRecap]),autoSkipCredits:Boolean(stored[KEYS.autoSkipCredits]),autoNextAfterCredits:Boolean(stored[KEYS.autoNextAfterCredits]),animateEpisodeList:stored[KEYS.animateEpisodeList] !== false,blurUpcoming:Boolean(stored[KEYS.blurUpcoming]),hideUpcomingTitles:Boolean(stored[KEYS.hideUpcomingTitles])};}
